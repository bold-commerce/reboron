  ...
  var Factory = function (_Component) {
    ...
    (0, _createClass3.default)(Factory, [{
      ...
      value: function render() {
        ...
        var sharp = animation.getSharp && animation.getSharp(willHidden, this.props.rectStyle);
      ...
      value: function enter() {
        ...
        if (this.props.duration >= 0) setTimeout(function () {
          return _this2.hide("timeout");
